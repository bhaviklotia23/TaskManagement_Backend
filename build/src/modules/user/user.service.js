...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.createUser = function (username, email, password) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = this.userRepository.create({ username: username, email: email, password: password });
    ...
    UserService.prototype.comparePassword = function (plainPassword, hashedPassword) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {

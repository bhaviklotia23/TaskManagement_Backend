...
var UserController = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_1 = _a.sent();
                        next(new ApiError_1.ApiError("Failed to fetch users", 500));
                        return [3 /*break*/, 3];
    ...
    UserController.prototype.createUser = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, username, email, password, existingUser, error_2;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 3, , 4]);
                        _a = req.body, username = _a.username, email = _a.email, password = _a.password;
                        return [4 /*yield*/, userService.findUserByEmail(email)];
                    case 1:
                        existingUser = _b.sent();
                        if (existingUser) {
                            throw new ApiError_1.ApiError("User with this email already exists", 400);
                        }
                        return [4 /*yield*/, userService.createUser(username, email, password)];
                    case 2:
                        _b.sent();
                        res
                            .status(201)
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, userService.comparePassword(password, user.password)];
                    case 2:
